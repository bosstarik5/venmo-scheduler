...
from . import HTTPAuthenticationApi
...
class HTTPClient(Client):
    ...
    #     """
    #     # authn_api = HTTPAuthenticationApi(api_client=ApiClient(), device_id=device_id)
    #     return authn_api.login_with_credentials_cli(username=username, password=password)

    @staticmethod
    def get_auth_api(device_id: str = None) -> HTTPAuthenticationApi:
        return HTTPAuthenticationApi(api_client=ApiClient(), device_id=device_id)
